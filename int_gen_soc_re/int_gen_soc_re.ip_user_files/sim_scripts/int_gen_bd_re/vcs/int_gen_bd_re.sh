...
#
# Script generated by Vivado on Sun Mar 29 19:22:01 -0700 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : int_gen_bd_re.sh
...
#
# Usage        : int_gen_bd_re.sh
#                int_gen_bd_re.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                int_gen_bd_re.sh [-reset_run]
#                int_gen_bd_re.sh [-reset_log]
#                int_gen_bd_re.sh [-help]
#
...
#                script (type 'int_gen_bd_re.sh -help' for more information).
#
...
# script info
echo -e "int_gen_bd_re.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./int_gen_bd_re.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.int_gen_bd_re xil_defaultlib.glbl -o int_gen_bd_re_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./int_gen_bd_re_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key int_gen_bd_re_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc int_gen_bd_re_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./int_gen_bd_re.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: int_gen_bd_re.sh [-help]\n\
Usage: int_gen_bd_re.sh [-step]\n\
Usage: int_gen_bd_re.sh [-lib_map_path]\n\
Usage: int_gen_bd_re.sh [-reset_run]\n\
Usage: int_gen_bd_re.sh [-reset_log]\n\
Usage: int_gen_bd_re.sh [-keep_index]\n\
Usage: int_gen_bd_re.sh [-noclean_files]\n\n\
